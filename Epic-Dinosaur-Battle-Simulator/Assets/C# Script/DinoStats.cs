...
public class DinoStats
{
    ...
    public DinoStats() 
    {
        Dinosaurs.Add(new OneDinoStat("Allosaurus fragilis",5,5,5,500));
        Dinosaurs.Add(new OneDinoStat("T-rex", 5, 5, 5, 500));
        Dinosaurs.Add(new OneDinoStat("Spinozaur", 5, 5, 5, 500));
